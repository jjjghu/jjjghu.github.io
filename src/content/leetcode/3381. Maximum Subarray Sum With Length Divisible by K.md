...
title: "3381. 長度可被 K 整除的子數組的最大元素和"
en_title: "3381. Maximum Subarray Sum With Length Divisible by K"
...
en_link: "https://leetcode.com/problems/maximum-subarray-sum-with-length-divisible-by-k"
date: "2025-11-27"
---
## 思路
...
拿上面的矩陣舉例，\
當我想計算以`nums[5]`為終點，去找滿足題目條件的起點，\
我所能參考的起點有`nums[1]`, `nums[3]` 這兩個，肯定要選比較小的那一個。

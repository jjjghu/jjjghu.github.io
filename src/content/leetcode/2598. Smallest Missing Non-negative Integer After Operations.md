...
title: "2598. 執行操作後的最大MEX"
en_title: "2598. Smallest Missing Non-negative Integer After Operations"
...
en_link: "https://leetcode.com/problems/smallest-missing-non-negative-integer-after-operations/"
date: "2025-10-16"
---
## 思路
...
舉例來說，若`value = 5`，`nums[0] = 3`，`nums[1] = -2`，\
由於兩者相差為`1 * value`，能視為相同的數字，都能夠填補「能表示為`3 + n * value`的數字」。
